...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_get_recipe_detial(self):
    ...
    def test_create_recipe_on_update(self):
        """Test creating recipe when updating a recipe."""
        recipe = create_recipe(user=self.user)
